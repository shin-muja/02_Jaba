...
public class SetService {
	...
	public void method1() {
		...
		System.out.println(set.remove("U플러스"));
	...
	public void method2() {
		...
		for(Object snack : set ) {
			System.out.println(snack);
		}
	}
	
	/**
	 * 직접 만든 클래스를 이용해 만든 객체를
	 * Set에 저장(중복 제거 확인)
	 */
	public void method3() {
	...
	/** 로또 번호 생성기
	 * 금액을 입력받아( 천원 단위)
	 * 1000원당 1회 씩 번호를 생성해서 List에 저장 후
	 * 생성 종료 시 한 번에 출력
	 * 
	 * <pre>
	 * 금액 입력 : 3000
	 ...
	 * 
	 */
	public void lottoNumberGernerator() { 
		...
		// for문 반복 될때 마다 새로운 TreeSet 객체 생성
		...
		for(Set<Integer> list : lottoList) {
			System.out.println( ++i + "회 : " + list);
		}
