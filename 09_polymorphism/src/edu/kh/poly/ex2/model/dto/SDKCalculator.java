...
public class SDKCalculator implements Calculator /*, 다른인터페이스명*/{
	//extends : 확장하다, immplements : 구현하다
	...
	// 인터페이스 : 같은 메서드를 강제구현하면서 다른동작만을 구현하고자 할 떄 사용
