...
// model - 프로그램 로직과 관련되어있는 데이커를 저장하는 용도,
// VO(Velue Object) : 값 저장용 객체를 만들기 위한 클래스를 모아두는 패키지
// MVC(Model View Comtroller) 패턴
// Modle : 데이터 비즈니스 로직 담당 (vo / DTO)

public class People { // 국민(사람) 클래스
	
	// 클래스란 ? 객체의 특성(속성, 기능)을 정의한 것 - 설계도
	// == 객체를 만들기 위한 설계도
	...
	// name 변수에 값을 세팅하느 간접 접근 기능 중 setter
