package eud.kh.cls.model.service;

// ClsService와 Student는 패키지가 다름
import eud.kh.cls.model.vo.Student;
import eud.kh.cls.model.vo.User;
// import eud.kh.cls.model.vo.TestVO;

public class ClsService /*extends Student*/ {
			// 부모로 Student 클래스를 상속받음
			// Student(부모) -> ClsService(자식)

	// pulic ClsService() {} // 기본생성자
	...
	public void ex1() {
		...
		// TestVO test = new TesVO();
		// (default) class인 TestVO는 import 불가능(다른 패키지라 불가)
		
		// 필드 접근제한자 확인하기
		System.out.println(std.v1);
		// -> 전체에서 직접 접근 가능한 public인 v1만 에러발생x
		...
		// Student 클래스를 상속 받았으므로 Student의 protected 변수인
		// v2는 직접 접근 가능
		// System.out.println( v3 ); // (default) 다른패키 x
	...
	public void ex2() {
		...
		// schoolNmae에 노란줄이 뜨는 이유 (경고) => 문법에 따라 제대로 작성을 안해서
	...
	public void ex3() {
		...
		//          u2가 참조하고 있는 User객체의 필드값이 동일함
		// 같은 기본생성자로 User 객체를 생성했기 때문에
