...
//[접근제한자] [예약어] class 클래스명
	...
	// final 예약어
	private final int TEMP1 = 100; // 명명규칙 전부 대문자
	
	// getter 만 만들어진 이유 : final 예약어가 붙은 TEMP1은
		// 상수이기 때문에 재대입 불가능(== setter 굳이 X)
	public int getTEMP1() {
		return TEMP1;
	}
	...
	public void ex() {
		...
		// 필드 접근제한자 확인하기
		// v1~v4까지 전부 Strudent 클래스 내부에서 생성된 변수이기 때문에
	...
	public Student() {
		// 객체가 생성될 때 수행할 코드
		this.name = "기본생성자";
		System.out.println(this.name +"에 의해서 Student 객체 생성");
	} 
