...
public class Array2Example {
	...
	public void ex1() {
		...
		// Arrays.deeToString(배열명) :  참조하고 있는 1차원 배열 값을 문자열로 반환
		System.out.println("Arrays.toStirng() : " + Arrays.toString(arr));
		
		// Arrays.doopToString(배열명)
	...
	public void ex3() {
		...
		//  나중에 서로 크기가 다른 1차원 배열을생성하여 참조하는 배열
